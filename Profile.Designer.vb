...
Partial Class Profile
    ...
    Private Sub InitializeComponent()
        ...
        ContainerPanel.Size = New Size(1663, 1046)
        ContainerPanel.TabIndex = 0
        ' 
        ' PanelRound4
        ' 
        PanelRound4.BackColor = Color.White
        PanelRound4.Controls.Add(Panel2)
        ...
        PanelRound4.Location = New Point(22, 544)
        PanelRound4.Name = "PanelRound4"
        PanelRound4.Size = New Size(1621, 334)
        ...
        Panel2.Location = New Point(672, 236)
        Panel2.Name = "Panel2"
        ...
        EditAddressBtn.Location = New Point(1566, 14)
        ...
        Panel8.Location = New Point(26, 236)
        Panel8.Name = "Panel8"
        Panel8.Size = New Size(571, 52)
        Panel8.TabIndex = 9
        ' 
        ' UserLandmarkLbl
        ' 
        UserLandmarkLbl.AutoSize = True
        UserLandmarkLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserLandmarkLbl.ForeColor = Color.Black
        UserLandmarkLbl.Location = New Point(8, 29)
        UserLandmarkLbl.Name = "UserLandmarkLbl"
        UserLandmarkLbl.Size = New Size(86, 21)
        ...
        LandmarkLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        LandmarkLbl.ForeColor = SystemColors.ControlDarkDark
        LandmarkLbl.Location = New Point(8, 4)
        LandmarkLbl.Name = "LandmarkLbl"
        LandmarkLbl.Size = New Size(80, 21)
        ...
        Panel6.Location = New Point(672, 146)
        Panel6.Name = "Panel6"
        Panel6.Size = New Size(571, 52)
        Panel6.TabIndex = 8
        ' 
        ' UserBrgyLbl
        ' 
        UserBrgyLbl.AutoSize = True
        UserBrgyLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserBrgyLbl.ForeColor = Color.Black
        UserBrgyLbl.Location = New Point(8, 29)
        UserBrgyLbl.Name = "UserBrgyLbl"
        UserBrgyLbl.Size = New Size(86, 21)
        ...
        BarangayLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        BarangayLbl.ForeColor = SystemColors.ControlDarkDark
        BarangayLbl.Location = New Point(8, 4)
        BarangayLbl.Name = "BarangayLbl"
        BarangayLbl.Size = New Size(75, 21)
        ...
        Panel7.Location = New Point(672, 58)
        Panel7.Name = "Panel7"
        Panel7.Size = New Size(571, 52)
        Panel7.TabIndex = 7
        ' 
        ' UserProvinceLbl
        ' 
        UserProvinceLbl.AutoSize = True
        UserProvinceLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserProvinceLbl.ForeColor = Color.Black
        UserProvinceLbl.Location = New Point(8, 29)
        UserProvinceLbl.Name = "UserProvinceLbl"
        UserProvinceLbl.Size = New Size(86, 21)
        ...
        ProvinceLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ProvinceLbl.ForeColor = SystemColors.ControlDarkDark
        ProvinceLbl.Location = New Point(8, 4)
        ProvinceLbl.Name = "ProvinceLbl"
        ProvinceLbl.Size = New Size(70, 21)
        ...
        Panel9.Location = New Point(26, 146)
        Panel9.Name = "Panel9"
        Panel9.Size = New Size(571, 52)
        Panel9.TabIndex = 4
        ' 
        ' UserMunLbl
        ' 
        UserMunLbl.AutoSize = True
        UserMunLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserMunLbl.ForeColor = Color.Black
        UserMunLbl.Location = New Point(8, 29)
        UserMunLbl.Name = "UserMunLbl"
        UserMunLbl.Size = New Size(86, 21)
        ...
        MunicipalityLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        MunicipalityLbl.Size = New Size(95, 21)
        ...
        Panel10.Location = New Point(26, 58)
        Panel10.Name = "Panel10"
        Panel10.Size = New Size(571, 52)
        Panel10.TabIndex = 2
        ' 
        ' UserCountryLbl
        ' 
        UserCountryLbl.AutoSize = True
        UserCountryLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserCountryLbl.ForeColor = Color.Black
        UserCountryLbl.Location = New Point(8, 29)
        UserCountryLbl.Name = "UserCountryLbl"
        UserCountryLbl.Size = New Size(86, 21)
        ...
        CountryLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        CountryLbl.ForeColor = SystemColors.ControlDarkDark
        CountryLbl.Location = New Point(8, 4)
        CountryLbl.Name = "CountryLbl"
        CountryLbl.Size = New Size(66, 21)
        ...
        AddressLbl.Font = New Font("Verdana", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        AddressLbl.Location = New Point(26, 21)
        AddressLbl.Name = "AddressLbl"
        AddressLbl.Size = New Size(79, 18)
        ...
        PanelRound3.Location = New Point(22, 201)
        PanelRound3.Name = "PanelRound3"
        PanelRound3.Size = New Size(1621, 305)
        ...
        EditInfoBtn.Location = New Point(1566, 13)
        ...
        Panel4.Location = New Point(672, 142)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(571, 52)
        Panel4.TabIndex = 8
        ' 
        ' UserPhoneLbl
        ' 
        UserPhoneLbl.AutoSize = True
        UserPhoneLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserPhoneLbl.ForeColor = Color.Black
        UserPhoneLbl.Location = New Point(8, 29)
        UserPhoneLbl.Name = "UserPhoneLbl"
        UserPhoneLbl.Size = New Size(86, 21)
        ...
        Panel1.Location = New Point(672, 57)
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(571, 52)
        Panel1.TabIndex = 7
        ' 
        ' UserLNLbl
        ' 
        UserLNLbl.AutoSize = True
        UserLNLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserLNLbl.ForeColor = Color.Black
        UserLNLbl.Location = New Point(8, 29)
        UserLNLbl.Name = "UserLNLbl"
        UserLNLbl.Size = New Size(86, 21)
        ...
        LastNameLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        Panel5.Location = New Point(26, 228)
        Panel5.Name = "Panel5"
        Panel5.Size = New Size(571, 52)
        Panel5.TabIndex = 6
        ' 
        ' ChangePassBtn
        ' 
        ...
        ChangePassBtn.Font = New Font("Segoe UI", 9.75F, FontStyle.Underline, GraphicsUnit.Point, CByte(0))
        ChangePassBtn.ForeColor = SystemColors.Highlight
        ChangePassBtn.Location = New Point(4, 23)
        ChangePassBtn.Name = "ChangePassBtn"
        ChangePassBtn.Size = New Size(122, 26)
        ...
        PasswordLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        Panel3.Location = New Point(26, 142)
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(571, 52)
        Panel3.TabIndex = 4
        ' 
        ' UserEmailLbl
        ' 
        UserEmailLbl.AutoSize = True
        UserEmailLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserEmailLbl.ForeColor = Color.Black
        UserEmailLbl.Location = New Point(8, 29)
        UserEmailLbl.Name = "UserEmailLbl"
        UserEmailLbl.Size = New Size(86, 21)
        ...
        EmailAddLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        EmailAddLbl.ForeColor = SystemColors.ControlDarkDark
        EmailAddLbl.Location = New Point(8, 4)
        EmailAddLbl.Name = "EmailAddLbl"
        EmailAddLbl.Size = New Size(108, 21)
        ...
        Panel11.Location = New Point(26, 57)
        Panel11.Name = "Panel11"
        Panel11.Size = New Size(571, 52)
        Panel11.TabIndex = 2
        ' 
        ' UserFNLbl
        ' 
        UserFNLbl.AutoSize = True
        UserFNLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        UserFNLbl.ForeColor = Color.Black
        UserFNLbl.Location = New Point(8, 29)
        UserFNLbl.Name = "UserFNLbl"
        UserFNLbl.Size = New Size(86, 21)
        ...
        FirstNameLbl.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        PersonalInfoLbl.Font = New Font("Verdana", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        PersonalInfoLbl.Location = New Point(26, 17)
        PersonalInfoLbl.Name = "PersonalInfoLbl"
        PersonalInfoLbl.Size = New Size(195, 18)
        ...
        PanelRound2.Location = New Point(22, 33)
        PanelRound2.Name = "PanelRound2"
        PanelRound2.Size = New Size(1621, 125)
        ...
        HelloLbl.Location = New Point(180, 41)
        ...
        UserPicture.Location = New Point(26, 14)
