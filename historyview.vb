...
LIMIT 10"
    ...
    Private Sub LoadCustomerData(customerRow As DataRow)
        ...
        IDLbl.Text = Convert.ToInt32(customerRow("customer_id")).ToString("D5")
                                 ...
                                 Using adapter As New MySqlDataAdapter(cmd)
                                     ...
                                     Me.Invoke(Sub()
                                                   ...
                                                   For Each row As DataRow In dt.Rows
                                                       ...
                                                       Dim rawId As String = row("Reference").ToString().Replace("SVC-", "")
                                                       dgvRow.Cells("Reference").Value = "SVC-" & Convert.ToInt32(rawId).ToString("D5")
                                                   Next
                                                   SetLoadingState(False)
                                               End Sub)
                                 End Using
