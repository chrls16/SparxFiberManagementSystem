...
Public Class AdminInstallation
    ...
    Private Sub UpdateInstallationGrid(dt As DataTable)
        ...
        Try
            ...
            If IsReadOnly = True Then
                If DataGridInstallationDetails.Columns.Contains("EditIcon") Then
                    DataGridInstallationDetails.Columns("EditIcon").Visible = False
                End If
                If DataGridInstallationDetails.Columns.Contains("DeleteIcon") Then
                    DataGridInstallationDetails.Columns("DeleteIcon").Visible = False
                End If
                If DataGridInstallationDetails.Columns.Contains("checkbox") Then
                    DataGridInstallationDetails.Columns("checkbox").Visible = False
                End If
            End If
    ...
    Private Sub DataGridInstallationDetails_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridInstallationDetails.CellClick
        ...
        If IsReadOnly = True Then
            If columnName = "DeleteIcon" OrElse columnName = "EditIcon" OrElse columnName = "checkbox" Then
                Exit Sub
            End If
        End If
    ...
    Private Sub installationview_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If IsReadOnly = True Then
            ...
            If btnSelectInstallation IsNot Nothing Then btnSelectInstallation.Visible = False

            Dim btnSchedule As Control = FindControlRecursive(Me, "btnSchedule")
            If btnSchedule IsNot Nothing Then btnSchedule.Visible = False
        End If
