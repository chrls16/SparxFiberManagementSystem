...
Partial Class SABillingExport
    ...
    Private Sub InitializeComponent()
        ...
        cbBillingFilter = New ComboBox()
        LblBillingFilter = New Label()
        SuspendLayout()
        ' 
        ' btnCancel
        ' 
        ...
        LblExportReportForm.Size = New Size(186, 25)
        LblExportReportForm.TabIndex = 110
        LblExportReportForm.Text = "Billing Export Form"
        ' 
        ' cbExportFormat
        ' 
        ...
        cbExportFormat.Location = New Point(157, 285)
        ...
        ' cbBillingFilter
        ' 
        cbBillingFilter.DropDownStyle = ComboBoxStyle.DropDownList
        cbBillingFilter.Font = New Font("Segoe UI", 12.0F)
        cbBillingFilter.FormattingEnabled = True
        cbBillingFilter.Items.AddRange(New Object() {"All Billing", "Paid Only", "Unpaid Only"})
        cbBillingFilter.Location = New Point(157, 85)
        cbBillingFilter.Name = "cbBillingFilter"
        cbBillingFilter.Size = New Size(330, 29)
        cbBillingFilter.TabIndex = 113
        ' 
        ' LblBillingFilter
        ' 
        LblBillingFilter.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        LblBillingFilter.AutoSize = True
        LblBillingFilter.BackColor = Color.Transparent
        LblBillingFilter.Font = New Font("Verdana", 11.0F)
        LblBillingFilter.Location = New Point(31, 90)
        LblBillingFilter.Name = "LblBillingFilter"
        LblBillingFilter.Size = New Size(88, 18)
        LblBillingFilter.TabIndex = 112
        LblBillingFilter.Text = "Billing Filter"
        ' 
        ' SABillingExport
        ' 
        ...
        Controls.Add(cbBillingFilter)
        Controls.Add(LblBillingFilter)
        ...
        Name = "SABillingExport"
        StartPosition = FormStartPosition.CenterScreen
        Text = "SABillingExport"
        ResumeLayout(False)
        PerformLayout()
    End Sub
    ...
    Friend WithEvents cbBillingFilter As ComboBox
    Friend WithEvents LblBillingFilter As Label
End Class